...
class Common
{
	...
	public static var cvar_author_comment:String = "This save was made in an alpha version of openLR. Please respect my rights as a track maker and do not upload this track to any website without my permission, including video form.";
