 ...
 * @author Kaelan Evans
 * 
 * Haxe implementation of LZ-String from http://pieroxy.net/blog/pages/lz-string/index.html
 */
class LZString 
{
	...
	private static function getBaseValue(alphabet:String, character:String)
	{
