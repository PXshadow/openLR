...
class B2Skeleton extends SkeletonBase
{
	public function new(_anchors:Vector<CPoint>, _id:Int)
	{
		...
		this.edges[17] = new BindStick(_anchors[3], _anchors[7], this.riderID);// First peg to hand
		this.edges[18] = new BindStick(_anchors[8], _anchors[2], this.riderID);// Foot to lower nose
		this.edges[19] = new BindStick(_anchors[9], _anchors[2], this.riderID);// Foot to lower nose
