...
class HSlider extends Sprite
{
	...
	public function new(_min:Float = 0, _max:Float = 255, _value:Float = 0, _round = RoundMode.ROUND) 
	{
		...
		this.bar = Common.OLR_Assets.getMovieClip("Bar");
		this.barFill = Common.OLR_Assets.getMovieClip("FillBar");
		this.head = Common.OLR_Assets.getMovieClip("Head");
		this.headOutline = Common.OLR_Assets.getMovieClip("HeadOutline");
