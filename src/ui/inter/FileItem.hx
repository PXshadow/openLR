...
class FileItem extends Sprite
{
	...
	public function new(_path:String) 
	{
		...
		var _locNameLength:Int = _path.length;
		var _locExtensionJSON:String = _path.substring(_locNameLength - 5, _locNameLength);
		...
		this.msg.y = 4;
		this.msg.width = 370;
		this.msg.text = this.prefix + this.filePath;
