...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_475_get_src,"lime.media.AudioBuffer","get_src",0x0f304c40,"lime.media.AudioBuffer.get_src","lime/media/AudioBuffer.hx",475,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_508_set_src,"lime.media.AudioBuffer","set_src",0x0231dd4c,"lime.media.AudioBuffer.set_src","lime/media/AudioBuffer.hx",508,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_251_fromURL,"lime.media.AudioBuffer","fromURL",0x4067bcea,"lime.media.AudioBuffer.fromURL","lime/media/AudioBuffer.hx",251,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_294_fromVorbisFile,"lime.media.AudioBuffer","fromVorbisFile",0x6dde6b54,"lime.media.AudioBuffer.fromVorbisFile","lime/media/AudioBuffer.hx",294,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_388_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",388,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_321_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",321,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_437_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",437,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_405_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",405,0xf6fabaad)
namespace lime{
namespace media{
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,dispose,(void))
 ...
 ::Dynamic AudioBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_475_get_src)
HXLINE( 475)		return this->_hx___srcVorbisFile;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_508_set_src)
HXLINE( 508)		return (this->_hx___srcVorbisFile = ( ( ::lime::media::codecs::vorbis::VorbisFile)(value) ));
            	}
...
void AudioBuffer_obj::fromURL(::String url, ::Dynamic handler){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_251_fromURL)
HXLINE( 251)		bool _hx_tmp;
HXDLIN( 251)		bool _hx_tmp1;
HXDLIN( 251)		if (hx::IsNotNull( url )) {
HXLINE( 251)			_hx_tmp1 = (url.indexOf(HX_("http://",52,75,cd,5a),null()) == (int)-1);
            		}
            		else {
HXLINE( 251)			_hx_tmp1 = false;
            		}
HXDLIN( 251)		if (_hx_tmp1) {
HXLINE( 251)			_hx_tmp = (url.indexOf(HX_("https://",cf,b4,ae,3e),null()) == (int)-1);
            		}
            		else {
HXLINE( 251)			_hx_tmp = false;
            		}
HXDLIN( 251)		if (_hx_tmp) {
HXLINE( 253)			handler(::lime::media::AudioBuffer_obj::fromFile(url));
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AudioBuffer_obj,fromURL,(void))
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromVorbisFile( ::lime::media::codecs::vorbis::VorbisFile vorbisFile){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_294_fromVorbisFile)
HXLINE( 296)		if (hx::IsNull( vorbisFile )) {
HXLINE( 296)			return null();
            		}
HXLINE( 298)		 ::lime::media::codecs::vorbis::VorbisInfo info = vorbisFile->info(null());
HXLINE( 300)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 301)		audioBuffer->channels = info->channels;
HXLINE( 302)		audioBuffer->sampleRate = info->rate;
HXLINE( 303)		audioBuffer->bitsPerSample = (int)16;
HXLINE( 304)		audioBuffer->_hx___srcVorbisFile = vorbisFile;
HXLINE( 306)		return audioBuffer;
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::media::AudioBuffer buffer){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_388_loadFromFile)
HXLINE( 388)			if (hx::IsNotNull( buffer )) {
HXLINE( 390)				return ::lime::app::Future_obj::withValue(buffer);
            			}
            			else {
HXLINE( 394)				return ::lime::app::Future_obj::withError(HX_("",00,00,00,00));
            			}
HXLINE( 388)			return null();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_321_loadFromFile)
HXLINE( 385)		 ::lime::net::_HTTPRequest_lime_media_AudioBuffer request =  ::lime::net::_HTTPRequest_lime_media_AudioBuffer_obj::__alloc( HX_CTX ,null());
HXLINE( 386)		return request->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFiles(::Array< ::String > paths){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0,::Array< ::String >,paths) HXARGC(0)
            		 ::lime::media::AudioBuffer _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_437_loadFromFiles)
HXLINE( 437)			return ::lime::media::AudioBuffer_obj::fromFiles(paths);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_405_loadFromFiles)
HXLINE( 407)		 ::lime::app::Promise_lime_media_AudioBuffer promise =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 437)		promise->completeWith( ::lime::app::Future_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(paths)),true));
HXLINE( 441)		return promise->future;
            	}
