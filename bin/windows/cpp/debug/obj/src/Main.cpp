...
HX_DEFINE_STACK_FRAME(_hx_pos_e47a9afac0942eb9_55_new,"Main","new",0x6616a5cb,"Main.new","Main.hx",55,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_64_init_env,"Main","init_env",0x9ffef2b3,"Main.init_env","Main.hx",64,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_75_init_track,"Main","init_track",0x793f3ad1,"Main.init_track","Main.hx",75,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_87_resize,"Main","resize",0x39257969,"Main.resize","Main.hx",87,0x087e5c05)

void Main_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_55_new)
HXLINE(  56)		super::__construct();
HXLINE(  58)		this->init_env();
HXLINE(  59)		this->init_track();
HXLINE(  61)		this->stage->addEventListener(HX_("resize",f4,59,7b,08),this->resize_dyn(),null(),null(),null());
            	}
...
void Main_obj::init_env(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_64_init_env)
HXLINE(  65)		::global::Common_obj::gCode = hx::ObjectPtr<OBJ_>(this);
HXLINE(  66)		::global::Common_obj::gStage = this->stage;
HXLINE(  68)		::global::Common_obj::stage_height = this->stage->stageHeight;
HXLINE(  69)		::global::Common_obj::stage_width = this->stage->stageWidth;
HXLINE(  71)		this->saveManager =  ::file::SaveManager_obj::__alloc( HX_CTX );
            	}
...
void Main_obj::init_track(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_75_init_track)
HXLINE(  76)		this->visContainer =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );
HXLINE(  77)		this->addChild(this->visContainer);
HXLINE(  78)		::global::Common_obj::gVisContainer = this->visContainer;
HXLINE(  80)		this->track =  ::lr::Track_obj::__alloc( HX_CTX );
HXLINE(  81)		this->visContainer->addChild(this->track);
HXLINE(  83)		this->toolBar =  ::lr::Toolbar_obj::__alloc( HX_CTX );
HXLINE(  84)		this->visContainer->addChild(this->toolBar);
            	}
...
void Main_obj::resize( ::openfl::events::Event e){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_87_resize)
HXLINE(  88)		::haxe::Log_obj::trace(this->stage->stageWidth, ::Dynamic(hx::Anon_obj::Create(5)
            			...
            			->setFixed(4,HX_("lineNumber",dd,81,22,76),(int)88)));
HXLINE(  89)		 ::openfl::display::MovieClip _hx_tmp = this->visContainer;
HXDLIN(  89)		_hx_tmp->set_x(this->visContainer->set_y((int)0));
HXLINE(  90)		 ::lr::Toolbar _hx_tmp1 = this->toolBar;
HXDLIN(  90)		Float _hx_tmp2 = ((Float)this->stage->stageWidth / (Float)(int)2);
HXDLIN(  90)		_hx_tmp1->set_x((_hx_tmp2 - ((Float)this->toolBar->get_width() / (Float)(int)2)));
HXLINE(  92)		::global::Common_obj::stage_height = this->stage->stageHeight;
HXLINE(  93)		::global::Common_obj::stage_width = this->stage->stageWidth;
            	}
