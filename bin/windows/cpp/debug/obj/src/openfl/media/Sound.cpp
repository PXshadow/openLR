...
HXDLIN( 150)			if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
...
HXDLIN( 150)			{
HXLINE( 150)				newByteLength = bufferByteLength;
...
HXDLIN( 150)			_this->byteOffset = (int)0;
